...
// POST /api/cli/email-enrich
func (c *Client) EmailEnrich(ctx context.Context, email string) (json.RawMessage, error) {
	return c.post(ctx, "/api/cli/email-enrich", map[string]string{"email": email})
}
