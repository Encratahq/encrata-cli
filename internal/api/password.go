...
// POST /api/password/breaches
func (c *Client) PasswordBreaches(ctx context.Context, sha1 string) (json.RawMessage, error) {
	return c.post(ctx, "/api/password/breaches", map[string]string{"sha1": sha1})
}
...
// POST /api/password/breaches/bulk
func (c *Client) PasswordBreachesBulk(ctx context.Context, sha1s []string) (json.RawMessage, error) {
	return c.post(ctx, "/api/password/breaches/bulk", map[string][]string{"sha1s": sha1s})
}
