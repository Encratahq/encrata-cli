...
func newClient() (api.API, error) {
	return app.newAPI(app.cfg)
}

// jsonMode reports whether output should be raw JSON.
func jsonMode() bool {
	return app.cfg.Output == "json"
}
...
func simpleGet(fn func(api.API, context.Context, string) (json.RawMessage, error), title string) func(*cobra.Command, []string) error {
